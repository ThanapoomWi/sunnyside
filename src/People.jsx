...
function People() {
  return (
    <div className="w-full h-full md:px-[50px] lg:px-[150px] py-[100px] md:py-[150px] xl:py-[200px] text-center">
      <div className="block">
        <h1
          id="text"
          className="uppercase tracking-[.25em] font-extrabold text-gray-400 text-2xl"
        >
          client testimonials
        </h1>
      </div>
      <div className="md:grid grid-cols-3 gap-20 text-center sm:p-[10px] sm:pt-[100px] p-[0px]">
        <div className="p-2 pt-20 py-[0px] md:py-0">
          <div className="flex items-center justify-center">
            <img src={pic1} className="rounded-full w-[30%]" />
          </div>
          <div>
            <p className="py-[30px] md:py-[50px] text-gray-500">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia iste
              sequi culpa iure nisi inventore?
            </p>
          </div>
          <h1 id="people" className="font-extrabold text-2xl py-5">
            Emily B.
          </h1>
        ...
        <div className="p-2 py-[80px] md:py-0">
          ...
          <div>
            <p className="py-[30px] md:py-[50px] text-gray-500">
              Lorem ipsum dolor sit amet, Lorem, ipsum. suscipit.lorem5 Lorem
        ...
        <div className="p-2 py-[0px] md:py-0">
          ...
          <div>
            <p className="py-[30px] md:py-[50px] text-gray-500">
              ...
              commodi eligendi in, veritatis ullam.
            </p>
          </div>
          <h1 id="people" className="font-extrabold text-2xl py-5">
            Jennie F.
